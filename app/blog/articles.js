export const BLOG_ARTICLES = {
  'why-physical-notice-boards-dont-work': {
    ...
    readTime: '5 min read',
    description:
      "Crew miss critical updates, there's no audit trail, and information gets buried. Here's why digital is the only way forward.",
    body: [
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'The off-watch problem' },
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'No proof of reading' },
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'Version control does not exist' },
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'Information gets buried' },
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: "WhatsApp is not the solution" },
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'The notice board is going digital' },
      {
        type: 'p',
        text:
  ...
  'ism-audit-preparation-checklist': {
    ...
    readTime: '7 min read',
    description:
      'A step-by-step guide to preparing for your next ISM audit using digital compliance records.',
    body: [
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'What auditors actually look for' },
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'The 30-day pre-audit checklist' },
      {
        type: 'p',
        text:
      ...
      },
      {
        ...
        items: [
          {
            title: '30 days before — Compliance baseline',
            body:
          ...
          {
            title: '21 days before — Document review',
            body:
          ...
          {
            title: '14 days before — Training check',
            body:
          ...
          {
            title: '7 days before — Activity log review',
            body:
          ...
          {
            title: 'Day before — Export and review',
            body:
      ...
      },
      {
        type: 'callout',
        variant: 'tip',
        title: 'Start earlier if you can',
        text:
          'The 30-day window is a minimum. Vessels that run a monthly compliance review throughout the year walk into audits with nothing to catch up on — the pre-audit checklist becomes a formality rather than a sprint.',
      },

      { type: 'h2', text: 'Evidence that impresses auditors' },
      {
        type: 'p',
        text:
      ...
      { type: 'h2', text: 'Common findings and how digital tools prevent them' },
      {
        type: 'p',
        text:
      ...
      },
      {
        type: 'callout',
        variant: 'note',
        title: "Finding vs observation",
        text:
          'Many of these issues show up as observations rather than non-conformities at first, but observations become findings if they persist into the next audit. Fixing them digitally means they stop showing up at all.',
      },
      ...
      { type: 'h2', text: 'Preparation without preparation' },
      {
        type: 'p',
        text:
